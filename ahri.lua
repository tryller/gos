...
OnTick(function(myHero)
	...
	if Mode() == "Harass" and GetPercentMP(myHero) >= menu.Harass.Mana:Value() then
    ...
    for i,mobs in pairs(minionManager.objects) do
		if Mode() == "LaneClear" and GetTeam(mobs) == 300 and GetPercentMP(myHero) >= menu.JungleClear.Mana:Value() then
	...
	if Mode() == "LastHit" and GetTeam(mobs) == MINION_ENEMY and GetPercentMP(myHero) >= menu.Lasthit.Mana:Value() then
